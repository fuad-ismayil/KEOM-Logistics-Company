            ...
            <div className=" w-full px-[24px] lg:px-[120px]">
                <div className="mb-[80px] text-center">
                    ...
                    <div className="mx-auto flex max-w-[820px] items-center gap-4">
                        ...
                        <span className="text-[14px] font-[700] uppercase tracking-[0.14em] text-[#FF7D44]">
                            our team
                        </span>
                                    ...
                                    <div className="pt-[26px] pb-[44px]">
                                        <div className={["grid items-stretch gap-y-[28px]", "lg:grid-cols-[408px_360px_1fr] lg:gap-x-[80px]",].join(" ")}>
                                            <div className="min-w-0">
                                                <div className="relative aspect-square w-full max-w-[408px] justify-self-center lg:justify-self-start">
                                                    ...
                                                    <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                                                        <div className="text-[10px] font-[800] uppercase tracking-[0.18em]">
                                                            START FROM
                                                        </div>
                                                        <div className="mt-[10px] text-[64px] font-[900] leading-[1]">
                                                            {item.price}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="min-w-0 pt-[6px] lg:self-center">
                                                <ul className="m-0 list-none space-y-[14px] p-0">
                                                    {item.leftBullets.map((b) => (<CheckBullet key={b} text={b} />))}
                                                </ul>
                                            </div>
                                            <div className="min-w-0 pt-[6px] lg:self-center">
                                                <ul className="m-0 list-none space-y-[16px] p-0">
                                                    {item.rightBullets.map((b) => (<CheckBullet key={b} text={b} />))}
                                                </ul>
