            ...
            (entries) => {
                entries.forEach((entry) => {
                    if (entry.isIntersecting) {
                        ...
                        if (entry.target === truckRef.current) {
            ...
            <div className="mx-auto w-full">
                <div className="grid items-center gap-8 lg:gap-12 lg:grid-cols-2">
                    ...
                    <div className="relative flex justify-center lg:block">
                        ...
                        {/* Main image */}
                        <div ref={mainImageRef} className={`relative overflow-hidden reveal-mask ${mainImageVisible ? 'animate' : ''}`}>
                            <Image
                                src="/images/about/aboutarea/about_img_01.jpg"
                                alt="Shipping"
                                className="object-cover w-[342px] h-[410px] lg:w-[500px] lg:h-[600px]"
                                priority
                                width={500}
                                height={600}
                            />
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="absolute right-[10px] top-[15px] lg:right-[20px] lg:top-[30px]"
                                aria-label="Play video"
                            >
                                <Image
                                    src="/images/about/aboutarea/play.png"
                                    alt="Play"
                                    width={220}
                                    height={220}
                        ...
                        {/* Truck overlay */}
                        <div className="absolute left-[-240px] bottom-[15px] lg:left-[-250px] lg:bottom-[110px] max-w-[472px]">
                            {/* Mask sadece bunu kesiyor, image sabit */}
                            <div ref={truckRef} className={`reveal-mask ${truckVisible ? 'animate' : ''}`}>
                                <Image
                                    src="/images/about/aboutarea/truck.png"
                                    alt="Truck"
                                    width={472}
                                    height={190}
                    ...
                    <div className=" lg:text-left lg:pl-[20px]">
                        <h2 className="text-[40px] text-center lg:text-left lg:text-[60px] break-keep whitespace-normal leading-[1.2] font-[700]">
                           ...
                           <WavyText 
  text="around the corners" 
  className="text-[#003b49] !whitespace-normal" 
/>
                        </h2>
                        ...
                        <div className="mt-6 lg:mt-[30px]">
                            <a
                                href="/about"
                                className="inline-flex h-[50px] w-[190px] items-center justify-center bg-[#FF7D44] text-[13px] font-bold uppercase text-white transition hover:brightness-95"
                            >
                                Discover More
                            </a>
                        </div>
