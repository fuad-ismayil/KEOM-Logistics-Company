      ...
      <div className="mx-auto w-full">
        <div className="grid items-center gap-8 lg:gap-12 lg:grid-cols-2">
          <div className="relative flex justify-center lg:block">
            {/* ✅ SIZE THE WRAPPER (NOT THE IMG) */}
           <div
  ref={mainImageRef}
  className={`relative overflow-hidden reveal-mask ${
    mainImageVisible ? "animate" : ""
  }
  w-[85vw] md:w-[87.5vw] lg:w-[500px] lg:h-[600px]
...
>
  <Image
    ...
    height={600}
    priority
    sizes="(min-width: 1024px) 500px, (min-width: 768px) 87.5vw, 85vw"
