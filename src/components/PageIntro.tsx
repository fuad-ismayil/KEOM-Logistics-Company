...
export default function PageIntro({ title, link }: { title: string; link: string; }) {
    return (
        <section className="overflow-hidden introduction justify-center min-h-[450px] bg-scroll lg:bg-fixed -z-10 flex w-full flex-col bg-[url('/images/introduction/bg.jpg')] bg-cover bg-center px-[24px] lg:px-[8%]">
